...
{
    internal class FiniteFieldNumber
    {
        #region Свойства
        ...
        #region Конструкторы
        internal FiniteFieldNumber(BigInteger value, BigInteger prime)
        {
            Prime = prime;
            Value = Mod(value);
        }
        ...
        internal FiniteFieldNumber Copy() => new(Value, Prime);

        internal FiniteFieldNumber Inverse()
        {
        ...
        internal static FiniteFieldNumber Pow(FiniteFieldNumber value, BigInteger exponent)
        {
