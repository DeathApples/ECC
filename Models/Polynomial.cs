...
namespace ECDH.Models
{
    public class Polynomial
    {
        ...
        public BigInteger Degree => Monomials.Count > 0 ? Monomials.Keys.Select(key => key.xPower + key.yPower).Max() : 0;

        public Dictionary<(BigInteger xPower, BigInteger yPower), FiniteFieldNumber> MonomialsWithMaxDegree => Monomials.Where(monomial => monomial.Key.xPower + monomial.Key.yPower == Degree).ToDictionary();

        public Dictionary<(BigInteger xPower, BigInteger yPower), FiniteFieldNumber> Monomials { get; } = [];

        public static Polynomial X => new((1, 1, 0));
        ...
        public Polynomial(FiniteFieldNumber a)
        {
            if (a.Prime != Prime)
        ...
        public Polynomial(Dictionary<(BigInteger xPower, BigInteger yPower), FiniteFieldNumber> monomials)
        {
        ...
        public Polynomial(params (BigInteger coefficient, BigInteger xPower, BigInteger yPower)[] monomials)
        {
        ...
        public Polynomial(params (FiniteFieldNumber coefficient, BigInteger xPower, BigInteger yPower)[] monomials)
        {
            foreach (var (coefficient, xPower, yPower) in monomials)
            {
        ...
        public Polynomial Copy() => new(Monomials);

        public Polynomial Inverse(Polynomial M)
        {
        ...
        public static Polynomial GreatestCommonDivisor(Polynomial P, Polynomial Q) => ExtendedEuclideanAlgoritm(P, Q, out _, out _);

        public static Polynomial ModReplaceSquareY(Polynomial P, Polynomial M)
        {
        ...
        public static Polynomial ModReplaceXY(Polynomial P, Polynomial Xp, Polynomial Yp, Polynomial M)
        {
            var result = new Polynomial();
        ...
        public static Polynomial Pow(Polynomial P, BigInteger exponent)
        {
            if (exponent < 0)
        ...
        public static Polynomial ModPow(Polynomial P, BigInteger exponent, Polynomial M)
        {
            if (exponent < 0)
                throw new ArgumentException("Exponent must be greater than 0");
        ...
        public static Polynomial ModPsi(BigInteger n, Polynomial M)
        {
        ...
        public static Polynomial F(BigInteger n)
        {
